...
#define MJPEG_FILENAME           "/Hamster_Long_240_20fps.mjpeg"
#define FPS                      20
...
{
  // Show video
  ShowVideoBlocking(&SPIFFS, MJPEG_FILENAME);
}
...
void ShowVideoBlocking(FS* fs, const char* path)
{
  ...
  if (!vFile || vFile.isDirectory())
  {
    ...
    DrawCenteredString(F("ERROR: Failed to open " MJPEG_FILENAME));
    return;
  }
  ...
  if (!Player.Setup(vFile))
  {
    ...
    DrawCenteredString(F("ERROR: " MJPEG_FILENAME " not valid"));
    return;
  }
